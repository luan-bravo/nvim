...
vim.keymap.set("v", "<leader>,\"", "di\"\"<C-c>P", { desc = "Surround w/ \"" })
vim.keymap.set("v", "<leader>,'", "di''<C-c>P", { desc = "Surround w/ '" })
vim.keymap.set("v", "<leader>,<", "di<><C-c>P", { desc = "Surround w/ <" })
vim.keymap.set("v", "<leader>,>", "di<><C-c>P", { desc = "Surround w/ >" })
vim.keymap.set("v", "<leader>,{", "di{}<C-c>P", { desc = "Surround w/ {" })
vim.keymap.set("v", "<leader>,}", "di{}<C-c>P", { desc = "Surround w/ }" })
vim.keymap.set("v", "<leader>,<leader>{", "di{  }<C-c>hP", { desc = "Surround w/ { spaced" })
vim.keymap.set("v", "<leader>,<leader>}", "di{  }<C-c>hP", { desc = "Surround w/ } spaced" })
vim.keymap.set("v", "<leader>,(", "di()<C-c>P", { desc = "Surround w/ (" })
vim.keymap.set("v", "<leader>,)", "di()<C-c>P", { desc = "Surround w/ )" })
vim.keymap.set("v", "<leader>,[", "di[]<C-c>P", { desc = "Surround w/ [" })
...
vim.keymap.set("v", "<leader>,<leader>[", "di[  ]<C-c>hP", { desc = "Surround w/ [ spaced" })
vim.keymap.set("v", "<leader>,<leader>]", "di[  ]<C-c>hP", { desc = "Surround w/ ] spaced" })
vim.keymap.set("v", "<leader>,l", "di[[]]<C-c>hP", { desc = "Surround w/ l" })
vim.keymap.set("v", "<leader>,<leader>l", "di[[  ]]<C-c>hP", { desc = "Surround w/ l spaced" })
vim.keymap.set("v", "<leader>,*", "di**<C-c>P", { desc = "Surround w/ *" })
vim.keymap.set("v", "<leader>,i", "di**<C-c>P", { desc = "Surround w/ i" })
vim.keymap.set("v", "<leader>,b", "di****<C-c>hP", { desc = "Surround w/ b" })
vim.keymap.set("v", "<leader>,I", "di******<C-c>hhP", { desc = "Surround w/ I" })
vim.keymap.set("v", "<leader>,B", "di******<C-c>hhP", { desc = "Surround w/ B" })
