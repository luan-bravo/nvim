...
vim.keymap.set("v", "<leader>,{", "di{}<esc>P", { desc = "Surround w/ {" })
vim.keymap.set("v", "<leader>,}", "di{}<esc>P", { desc = "Surround w/ }" })
vim.keymap.set("v", "<leader>,<leader>{", "di{  }<esc>hP", { desc = "Surround w/ { spaced" })
vim.keymap.set("v", "<leader>,<leader>}", "di{  }<esc>hP", { desc = "Surround w/ } spaced" })
vim.keymap.set("v", "<leader>,(", "di()<esc>P", { desc = "Surround w/ (" })
vim.keymap.set("v", "<leader>,)", "di()<esc>P", { desc = "Surround w/ )" })
vim.keymap.set("v", "<leader>,[", "di[]<esc>P", { desc = "Surround w/ [" })
...
vim.keymap.set("v", "<leader>,<leader>l", "di[[  ]]<esc>hhP", { desc = "Surround w/ [[ spaced" })
vim.keymap.set("v", "<leader>,*", "di**<esc>P", { desc = "Surround w/ *" })
vim.keymap.set("v", "<leader>,i", "di**<esc>P", { desc = "Surround w/ i" })
