...
-- Terminal mode
vim.keymap.set("t", "<A-<Esc>>", "<C-\\><C-n>", { noremap = true, desc = "Escape terminal mode" })
vim.keymap.set("t", "<C-<Esc>>", "<C-\\><C-n>", { noremap = true, desc = "Escape terminal mode" })
vim.keymap.set("t", "<C-A-<Esc>>", "<C-\\><C-n>", { noremap = true, desc = "Escape terminal mode" })
vim.keymap.set("t", "<A-c>", "<C-\\><C-n>", { noremap = true, desc = "Escape terminal mode" })
vim.keymap.set("t", "<C-c>", "<C-\\><C-n>", { noremap = true, desc = "Escape terminal mode" })
vim.keymap.set("t", "<C-A-c>", "<C-\\><C-n>", { noremap = true, desc = "Escape terminal mode" })

-- Easier double quotes
-- If there is the need to add more, refactor to be kind of like ./surround.lua
vim.keymap.set("v", "iq", "i\"", { desc = "Select inside double quotes - 'vi\"' alias" })
vim.keymap.set("v", "aq", "a\"", { desc = "Select around double quotes - 'va\"' alias" })
